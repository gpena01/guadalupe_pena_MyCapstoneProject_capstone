...
function createColumnElement(column, columnIndex) {
  ...
  editLink.innerHTML = `Edit <svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="dimgray" viewBox="0 0 512 512">
  ...
  deleteLink.innerHTML = `Delete <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
